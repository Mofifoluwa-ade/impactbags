...
export const metadata: Metadata = {
  title: "ImpactAI — Community Tokens, Real Change",
  ...
  openGraph: { title: "ImpactAI — Community Tokens, Real Change", description: "Launch a community impact token on Solana in 60 seconds.", type: "website" },
};
