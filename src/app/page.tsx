...
function FeaturesSection() {
  const features = [
    { icon: <Zap size={20} className="text-brand-gold" />, title: "AI token generation", desc: "Gemini AI instantly creates a name, ticker, description, and viral hook for your cause." },
